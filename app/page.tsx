  ...
  return (
    <div className="flex justify-center items-center w-full px-4 py-8">
      <div className="w-full max-w-4xl flex flex-col items-center gap-8 text-center">
        ...
        >
          Embark on a transformative journey through Islamic spiritual
          practices. Our comprehensive resource provides in-depth insights into
          Salat (Prayer), Sawm (Fasting), Hajj (Pilgrimage), and Zakat
          (Charity). Discover authentic guidance rooted in the Quran and Hadith,
          helping you deepen your understanding and practice of Islamic
          principles.
        </p>
        ...
        <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 py-12">
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 transform transition-all hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              Salat is the cornerstone of Islamic worship, connecting believers
              directly with Allah. Performed five times daily, it provides
              spiritual discipline, inner peace, and a constant reminder of
              divine guidance. Each prayer is a moment of reflection, gratitude,
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 transform transition-all hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              Fasting during Ramadan is a profound spiritual practice of
              self-discipline and empathy. It teaches patience, compassion, and
              gratitude while purifying the soul and strengthening community
              bonds. From dawn to sunset, Muslims abstain from food and drink,
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 transform transition-all hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              The Hajj is a transformative journey to Mecca, undertaken at least
              once by those physically and financially able. It symbolizes
              unity, equality, and submission to Allah. Pilgrims from around the
              world come together, wearing simple white garments, demonstrating
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 transform transition-all hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              Zakat is a mandatory form of giving that purifies wealth and
              supports community welfare. Muslims give 2.5% of their savings
              annually to help the poor, needy, and vulnerable. This practice
              promotes social justice, empathy, and economic balance within the
              community.
            </p>
          </div>
        </div>
        ...
        <div className="w-full bg-gray-50 py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8 leading-relaxed">
              Dua is the intimate conversation between a believer and Allah.
              More than just a prayer, it is a profound expression of trust,
              hope, and surrender. Through Dua, Muslims seek guidance, express
              gratitude, and find solace in every aspect of life.
            </p>
              ...
              {[
                ...
                >
                  ...
                  <p className="text-gray-600">
                    A powerful way to connect with the divine, reflecting the
                    essence of spiritual communication in Islam.
                  </p>
                </div>
              ))}
            </div>
